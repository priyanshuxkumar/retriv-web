...
export function LoginForm({
  ...
  return (
    <div
      className={cn("flex justify-center items-center gap-6", className)}
      {...props}
    >
      <div className="w-full max-w-md">
        ...
        <div className="text-start text-base mb-8">
          ...
          <Link
            href="/signup"
            className="underline underline-offset-4 text-blue-500 hover:underline"
          >
            Sign up
          </Link>
        </div>

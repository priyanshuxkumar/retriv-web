...
export default function SettingsGeneralTab() {
  ...
  async function onSubmit(data: z.infer<typeof AgentSettingsSchema>) {
    try {
      const response = await AxiosInstance.patch("/api/v1/settings/general",
        {
  ...
  const resetSettingsToDefault = async () => {
    try {
      const response = await AxiosInstance.patch("/api/v1/settings/general/reset",
        {},
        {
          withCredentials: true,
          headers: {
        ...
        <>
          <Card className="border-none shadow-none bg-transparent mb-0">
            <CardHeader>
              ...
              <CardDescription>
                View and manage your agent&apos;s basic information
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="font-medium">
                    {generalSettings?.basicInfo.agentName}
                  </p>
                </div>
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-muted-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium">
                    {generalSettings?.basicInfo?.sourceUrl}
                  </p>
                </div>
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-muted-foreground">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <p className="font-medium">
                    {new Date(
                      generalSettings?.basicInfo?.creationDate || ""
                    ).toDateString()}
                  </p>
                </div>
              </div>
